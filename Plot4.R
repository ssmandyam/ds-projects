...
labf <- 0.7
#plot1
plot(pdata$Time, pdata$Global_active_power, type="s", 
     xlab="", ylab="Global Active Power", cex.lab=labf)
#plot2
plot(pdata$Time, pdata$Sub_metering_1, type="s", cex.lab=labf, xlab="", ylab="Energy sub metering")
lines(pdata$Time, pdata$Sub_metering_2, col="red")
lines(pdata$Time, pdata$Sub_metering_3, col="blue")
legend("topright",
       c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"),
       lty=c(1,1,1),
       col=c("black", "red","blue"), cex=labf, bty="n")
#plot3
plot(pdata$Time, pdata$Voltage, type="s", cex.lab=labf, xlab="datetime", ylab="Voltage")
#plot4
plot(pdata$Time, pdata$Global_reactive_power, type="s", cex.lab=labf, xlab="datetime", ylab="Global_reactive_power")
